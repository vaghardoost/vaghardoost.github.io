        ...
        <ul className={style.timeline}>
          <li>
            ...
            <div className={style.timeline_panel}>
              ...
              <ul className={style.cader}>
                <li>
                  <a className={style.link} target="_blank" href="https://cafebazaar.ir/app/com.example.dastyar">دستیار زبان کلمه</a>
                  <p> تابستان ۱۴۰۰ در کافه بازار منتشر شد این اپ با مدیریت وضعیت Get.X کار میکند و از پایگاه داده محلی (sqflite) بهره میبرد</p>
                </li>
                <li>
                  <a className={style.link} target="_blank" href="https://cafebazaar.ir/app/com.vaghar.times">مدیریت زمان</a>
                  <p>اپلیکیشن با ابزار های مختلف برای محاسبات زمان و تاریخ که امکانات مختلفی را دارد انتشار در تابستان ۱۴۰۱ کافه بازار</p>
                  <p>برای اطلاعات بیشتر توی این <a className={style.link} target="_blank" href="/note/اپلیکیشن_مدیریت_زمان">پست</a> توضیح دادم</p>
                </li>

                <li>
                  <a className={style.link} target="_blank" href="/note/ایده_پردازی">مجله سرگرمی قاصدک</a>
          ...
          <li>
            ...
            <div className={style.timeline_panel}>
              ...
              <ul className={style.cader}>
                <li>
                  <a href="https://github.com/vaghardoost/FCMS" target="_blank" className={style.link}>سیستم مدیریت محتوا</a>
                  <p>
                  ...
                  <p>برای اطلاعات بیشتر توی این <a className={style.link} target="_blank" href="/note/معرفی_FCMS">پست</a> توضیح دادم</p>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li>
            ...
            <div className={style.timeline_panel}>
              ...
              <ul className={style.cader}>
                <li>
                  <a className={style.link} target="_blank" href="https://github.com/vaghardoost/Admin-Panel">پنل گرافیکی سیستم مدیریت محتوا</a>
                  <p>
                    پنل مدیریت محتوا برای سیستم backend سیستم مدیریت محتوا با استفاده از redux و ant design توسعه داده شده است.
                  </p>
                </li>
                <li>
                  <a className={style.link} target="_blank" href="https://github.com/vaghardoost/vaghardoost.github.io">وبلاگ شخصی</a> (همین این😅)
                  <p>
